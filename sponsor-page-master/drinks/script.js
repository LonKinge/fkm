...
var GithubLink  =   "https://github.com/LonKinge/fkm/tree/master/sponsor-page-master/";
var PayPalLink  =   "https://paypal.me/LonKinge?locale.x=zh_XC";
$('#paypal-donate>a').href = PayPalLink;
$('#github-box>a').href = GithubLink;
var qrcodes = {
    'btc_donate'	:	'https://files-cdn.cnblogs.com/files/blogs/688496/wkt.bmp',	// 二维码路径
    'alipay_donate'	:	'https://files-cdn.cnblogs.com/files/blogs/688496/zfbfk.bmp',	// 支付宝二维码
    'alipay_donate_link'   :   'null',   // 支付宝二维码上的链接，必须换成自己的连接！！！手机点击会自动跳转到支付宝。
    'wechat_donate'	:	'https://files-cdn.cnblogs.com/files/blogs/688496/wxfk.bmp'
};
